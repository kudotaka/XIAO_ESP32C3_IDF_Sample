...
static void I2CInit() {
    pcf8563_device = i2c_malloc_device(I2C_NUM_0, GPIO_NUM_6, GPIO_NUM_7, 400000, PCF8563_ADDR);
//    pcf8563_device = i2c_malloc_device(I2C_NUM_0, GPIO_NUM_6, GPIO_NUM_7, 100000, PCF8563_ADDR);
}
